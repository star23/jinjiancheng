...
- **375 篇**，时间跨度 **2022-11-05 → 2026-04-29**，约 **77 万字**。
...
- 目标站点 https://jinjiancheng.com/ 启用了 **Cloudflare 反爬**，且本运行环境的网络白名单不含该域名，
  无法直接抓取。本仓库的文章正文取自**公开的结构化文本镜像**，与原站文章一一对应、内容完整（非截断）。
- **时间边界**：存档止于 **2026-04**。其公众号 2026 年因合规多次被处罚/迁移，作者自述 2026-09-30 新规后
  将不再披露持仓与个股分析；**2026-05 之后**的内容不在本存档内。
- 2021 年的早期房地产系列文章在镜像中仅为 Cloudflare 挑战页（无正文），未能恢复。
